        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="justify-content-center">
                    ...
                    <form class="form-valide" action="<?php echo base_url('kkaAndKM9/insertKmProcess')?>" method="POST">
                        <div class="row-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <input type="text" name="spt_id" id="spt_id" value="<?= $this->uri->segment(3) ?>" hidden>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="nama_objek">Nama Objek <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="nama_objek" name="nama_objek" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="alamat">alamat <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="alamat" name="alamat" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="sasaran">sasaran <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="sasaran" name="sasaran" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                        <textarea class="form-control input-default" id="persiapan_t" name="persiapan_t" placeholder="Masukan Tujuan Pemeriksaan" required></textarea>
                                    </div>
                                </div>
                                <div class="wrapperPersiapan">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control input-default" id="persiapan_p" name="persiapan_p[]" placeholder="Masukan Prosedur Pemeriksaan" required></textarea>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                        <textarea class="form-control input-default" id="pelaksanaan_t" name="pelaksanaan_t" placeholder="Masukan Tujuan Pelaksanaan" required></textarea>
                                        </div>
                                </div>
                                <div class="wrapperPelaksanaan">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control input-default" id="pelaksanaan_p" name="pelaksanaan_p[]" placeholder="Masukan Prosedur Pelaksanaan" required></textarea>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                        <textarea class="form-control input-default" id="penyelesaian_t" name="penyelesaian_t" placeholder="Masukan Tujuan Penyelesaian" required></textarea>
                                        </div>
                                    </div>
                                    <div class="wrapperPenyelesaian">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-5">
                                                <textarea class="form-control input-default" id="penyelesaian_p" name="penyelesaian_p[]" placeholder="Masukan Prosedur Penyelesaian" required></textarea>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control input-default" id="pengendali_teknis" name="pengendali_teknis" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="ketua_tim">ketua tim <span class="text-danger">*</span></label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control input-default" id="ketua_tim" name="ketua_tim" value="<?= $nama; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="tanggal">tanggal <span class="text-danger">*</span></label>
                                    <div class="col-lg-8">
                                        <input type="date" class="form-control input-default" id="tanggal" name="tanggal" required>
                                    </div>
                                </div>
                            </div>
                        </div>
