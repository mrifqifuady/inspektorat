        ...
        <div class="container-fluid">
            <div class="justify-content-center">
                <div class="form-validation">
                    <form class="form-valide" action="<?php echo base_url('kkaAndKM9/updateKmProcess')?>" method="POST">
                        <div class="row-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <input type="text" name="spt_id" id="spt_id" value="<?= $km[0]['spt']['_id'] ?>" hidden>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="nama_objek">Nama Objek <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="nama_objek" name="nama_objek" value="<?= $km[0]['nama_objek']?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="alamat">alamat <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="alamat" name="alamat" value="<?= $km[0]['alamat']?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="sasaran">sasaran <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="sasaran" name="sasaran" value="<?= $km[0]['sasaran']?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="tahun">tahun <span class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-default" id="tahun" name="tahun" value="<?= $km[0]['tahun']?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control input-default" id="persiapan_t" name="persiapan_t" placeholder="Masukan Tujuan Pemeriksaan" required><?= $km[0]['pemerikasaan_t']?></textarea>
                                        </div>
                                    </div>
                                    <?php $firstpemeriksaan = true;
                                    for ($i=0; $i < count($km[0]['pemeriksaan_p']); $i++) { ?>
                                        <div class="wrapperPersiapan">
                                            <div class="form-group row">
                                                ...
                                                <?php if ($firstpemeriksaan) { ?>
                                                        <button id="btnAddPersiapan" class="btn btn-primary"><span class="fa fa-plus"></span></button>
                                                <?php $firstpemeriksaan=false; }else{?>
                                                        <button id="btnDelPersiapan" class="btn btn-danger"><span class="fa fa-minus"></span></button>
                                                <?php } ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control input-default" id="pelaksanaan_t" name="pelaksanaan_t" placeholder="Masukan Tujuan Pelaksanaan" required><?= $km[0]['penyelesaian_t'] ?></textarea>
                                        </div>
                                    </div>
                                    <?php $firstpelaksanaan = true; for ($i=0; $i < count($km[0]['pelaksanaan_p']); $i++) { ?>
                                    <div class="wrapperPelaksanaan">
                                        <div class="form-group row">
                                            ...
                                            <?php if ($firstpelaksanaan) { ?>
                                                <button id="btnAddPelaksanaan" class="btn btn-primary"><span class="fa fa-plus"></span></button>
                                            <?php $firstpelaksanaan=false; }else{?>
                                                <button id="btnDelPelaksanaan" class="btn btn-danger"><span class="fa fa-minus"></span></button>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <?php } ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control input-default" id="penyelesaian_t" name="penyelesaian_t" placeholder="Masukan Tujuan Penyelesaian" required><?= $km[0]['penyelesaian_t'] ?></textarea>
                                        </div>
                                    </div>
                                    <?php $firstpenyelesaiaan = true; for ($i=0; $i < count($km[0]['penyelesaian_p']); $i++) { ?>
                                    <div class="wrapperPenyelesaian">
                                        <div class="form-group row">
                                            ...
                                            <?php if ($firstpenyelesaiaan) { ?>
                                                <button id="btnAddPenyelesaian" class="btn btn-primary"><span class="fa fa-plus"></span></button>
                                            <?php $firstpenyelesaiaan=false; }else{?>
                                                <button id="btnDelPenyelesaian" class="btn btn-danger"><span class="fa fa-minus"></span></button>
                                        <?php } ?>
                                        </div>
                                    </div>
                                    <?php } ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control input-default" id="ketua_tim" name="ketua_tim" value="<?= $km[0]['ketua_tim']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
