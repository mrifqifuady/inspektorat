					...
					<div class="card">
						<div class="card-body">
							...
							<div class="form-validation">
								<form class="form-valide" action="<?php echo base_url('spt/insertProcess')?>" method="post">
									<div class="form-group row">
										<label class="col-lg-2 col-form-label" for="no_surat">No Surat <span class="text-danger">*</span></label>
										<div class="col-lg-4">
											<input type="number" class="form-control input-default" id="no_surat" name="no_surat">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<div class="card">
															...
															<div class="row">
																<select name="nama[]" id="nama" class="form-control input-default col-md-4 col-sm-4 col-xs-4 col-lg-4">
																	...
																	<?php foreach ($user as $key) {?>
																		<option value="<?= $key['_id'].'-*-'.$key['nama'];?>"><?= $key['nama'];?></option><?php }?>
																	</select>
																	<select name="peran[]" id="peran" class="form-control input-default col-md-4 col-sm-4 col-xs-4 col-lg-4">
																		...
																		<?php foreach ($peran as $key) {?>
																			<option value="<?= $key['_id'].'-*-'.$key['peran'];?>"><?= $key['peran'];?></option><?php }?>
																		</select>
												...
												<div class="form-group row">
													...
													<div class="col-lg-10">
														<textarea class="textarea_editor2 form-control" rows="15" id="tugas" name="tugas" placeholder="
														<div>Melaksanakan Evaluasi Kelengkapan Penanggungjawaban SPJ bulan Januari s.d Juni 2017 pada UPT. Perlindungan dan Pelayanan Sosial Anak Trenggalek, Dinas Sosial Provinsi Jawa Timur.</div>
														<div>Waktu Pelaksanaan tugas mulai tanggal 14 s.d 20 September 2017.</div>
														<div>Kepada pihak-pihak yang bersangkutan diminta&nbsp; kesediaannya untuk memberikan bantuan data serta keterangan yang diperlukan guna kelancaran dan penyelesaian tugas dimaksud.</div>
														<div>Seluruh biaya kegiatan dibenkan pada DPA Inspektorat Provinsi Jawa Timur Tahun 2017.<br></div>" style="height:450px">
											...
											<div class="form-group row">
												...
												<div class="col-lg-8">
													<input type="date" class="form-control input-default" id="waktu_awal" name="waktu_awal">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-lg-2 col-form-label" for="waktu_akhir">Waktu akhir <span class="text-danger">*</span></label>
												<div class="col-lg-8">
													<input type="date" class="form-control input-default" id="waktu_akhir" name="waktu_akhir">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-lg-2 col-form-label" for="gubernur">Gubernur <span class="text-danger">*</span></label>
												<div class="col-lg-8">
													<input type="text" class="form-control input-default" id="gubernur" name="gubernur" >
												</div>
											</div>
											<div class="form-group row">
